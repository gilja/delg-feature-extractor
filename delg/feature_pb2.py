...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        delf_dot_protos_dot_datum__pb2.DESCRIPTOR,
    ],
)
...
_DELFFEATURE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="descriptor",
            full_name="delf.protos.DelfFeature.descriptor",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="x",
            full_name="delf.protos.DelfFeature.x",
            index=1,
            number=2,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="y",
            full_name="delf.protos.DelfFeature.y",
            index=2,
            number=3,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="scale",
            full_name="delf.protos.DelfFeature.scale",
            index=3,
            number=4,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="orientation",
            full_name="delf.protos.DelfFeature.orientation",
            index=4,
            number=5,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="strength",
            full_name="delf.protos.DelfFeature.strength",
            index=5,
            number=6,
            type=2,
            cpp_type=6,
...
_DELFFEATURES = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="feature",
            full_name="delf.protos.DelfFeatures.feature",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_DELFFEATURE.fields_by_name["descriptor"].message_type = (
    delf_dot_protos_dot_datum__pb2._DATUMPROTO
)
...
DelfFeature = _reflection.GeneratedProtocolMessageType(
    "DelfFeature",
    (_message.Message,),
    dict(
...
DelfFeatures = _reflection.GeneratedProtocolMessageType(
    "DelfFeatures",
    (_message.Message,),
    dict(
