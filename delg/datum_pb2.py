...
_DATUMSHAPE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="dim",
            full_name="delf.protos.DatumShape.dim",
            index=0,
            number=1,
            type=3,
            cpp_type=2,
...
_FLOATLIST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="value",
            full_name="delf.protos.FloatList.value",
            index=0,
            number=1,
            type=2,
            cpp_type=6,
...
_UINT32LIST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="value",
            full_name="delf.protos.Uint32List.value",
            index=0,
            number=1,
            type=13,
            cpp_type=3,
...
_DATUMPROTO = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="shape",
            full_name="delf.protos.DatumProto.shape",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="float_list",
            full_name="delf.protos.DatumProto.float_list",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="uint32_list",
            full_name="delf.protos.DatumProto.uint32_list",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
    ...
    oneofs=[
        _descriptor.OneofDescriptor(
            name="kind_oneof",
            full_name="delf.protos.DatumProto.kind_oneof",
            index=0,
            containing_type=None,
            fields=[],
        ),
...
_DATUMPAIRPROTO = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="first",
            full_name="delf.protos.DatumPairProto.first",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="second",
            full_name="delf.protos.DatumPairProto.second",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_DATUMPROTO.fields_by_name["float_list"].containing_oneof = _DATUMPROTO.oneofs_by_name[
    "kind_oneof"
]
_DATUMPROTO.oneofs_by_name["kind_oneof"].fields.append(
    _DATUMPROTO.fields_by_name["uint32_list"]
)
_DATUMPROTO.fields_by_name["uint32_list"].containing_oneof = _DATUMPROTO.oneofs_by_name[
    "kind_oneof"
]
...
DatumShape = _reflection.GeneratedProtocolMessageType(
    "DatumShape",
    (_message.Message,),
    dict(
...
Uint32List = _reflection.GeneratedProtocolMessageType(
    "Uint32List",
    (_message.Message,),
    dict(
...
DatumProto = _reflection.GeneratedProtocolMessageType(
    "DatumProto",
    (_message.Message,),
    dict(
...
DatumPairProto = _reflection.GeneratedProtocolMessageType(
    "DatumPairProto",
    (_message.Message,),
    dict(
...
_DATUMSHAPE.fields_by_name["dim"]._options = _descriptor._ParseOptions(
    descriptor_pb2.FieldOptions(), _b("\020\001")
)
...
_UINT32LIST.fields_by_name["value"]._options = _descriptor._ParseOptions(
    descriptor_pb2.FieldOptions(), _b("\020\001")
)
